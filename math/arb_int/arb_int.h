...
class Integer;
static bool unsigned_greater(const Integer&, const Integer&);
static Integer add_same(const Integer&, const Integer&);
static Integer add_different(const Integer&, const Integer&);
...
static Integer add_same(const Integer& lhs, const Integer& rhs) {
